...
static void
test_az_iot_hub_client_commands_response_get_publish_topic_AZ_SPAN_EMPTY_request_id_fail()
{
  char test_buf[TEST_SPAN_BUFFER_SIZE];
  size_t test_length;
...
static void test_az_iot_hub_client_commands_parse_received_topic_AZ_SPAN_EMPTY_received_topic_fail()
{
  az_iot_hub_client client;
  assert_true(az_iot_hub_client_init(&client, test_device_hostname, test_device_id, AZ_SPAN_EMPTY, NULL) == AZ_OK);
...
static void test_az_iot_hub_client_commands_parse_received_topic_get_twin_topic_fail()
{
  az_iot_hub_client client;
  assert_true(az_iot_hub_client_init(&client, test_device_hostname, test_device_id, AZ_SPAN_EMPTY, NULL) == AZ_OK);
...
static void test_az_iot_hub_client_commands_parse_received_topic_twin_patch_topic_fail()
{
  az_iot_hub_client client;
  assert_true(az_iot_hub_client_init(&client, test_device_hostname, test_device_id, AZ_SPAN_EMPTY, NULL) == AZ_OK);
...
static void test_az_iot_hub_client_commands_no_logging_succeed()
{
  az_log_classification const classifications[]
...
int test_az_iot_hub_client_commands()
{
  ...
  const struct CMUnitTest tests[] = {
#ifndef AZ_NO_PRECONDITION_CHECKING
    cmocka_unit_test(test_az_iot_hub_client_commands_response_get_publish_topic_NULL_out_topic_fail),
    ...
    cmocka_unit_test(test_az_iot_hub_client_commands_parse_received_topic_EMPTY_received_topic_fail),
    cmocka_unit_test(
        test_az_iot_hub_client_commands_parse_received_topic_AZ_SPAN_EMPTY_received_topic_fail),
    ...
    cmocka_unit_test(test_az_iot_hub_client_commands_response_get_publish_topic_user_status_succeed),
    cmocka_unit_test(
    ...
    cmocka_unit_test(test_az_iot_hub_client_commands_parse_received_topic_get_twin_topic_fail),
    cmocka_unit_test(test_az_iot_hub_client_commands_parse_received_topic_twin_patch_topic_fail),
    ...
    cmocka_unit_test(test_az_iot_hub_client_commands_no_logging_succeed),
  };
